              ...
              <DialogContent className="glass-panel max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={formData.background_image_url || "none"}
                      onValueChange={(value) => setFormData({ ...formData, background_image_url: value === "none" ? "" : value })}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selectează imagine" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="none">Fără fundal</SelectItem>
